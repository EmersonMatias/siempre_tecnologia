        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, findUsers()];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
function toggleStatusAccount(dataUpdate, dataToken, userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!userId || typeof (userId) !== "number")
                        throw { message: "Data is not allowedz", status: 401 };
                    if (typeof (dataUpdate) !== "boolean")
                        throw { message: "Data is not allowed", status: 401 };
                    if (dataToken.account_type === "user")
                        throw { message: "User is not allowed", status: 401 };
                    return [4 /*yield*/, upadteStatusAccount(dataUpdate, userId)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
