...
export function getAllProducts(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, FindManyProducts(id)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
export function RegisterProductsScreen(product, screenId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var productExist;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("excluiu");
                    return [4 /*yield*/, DeleteProductScreen(productExist.id)];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    console.log("inseriu");
                    return [4 /*yield*/, RegisterProductForScreen(product, screenId, userId)];
                case 4: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
export function GetProductsScreen(screenId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!screenId)
                        throw { message: "empty", status: 404 };
                    return [4 /*yield*/, GetAllProductsScreen(screenId, userId)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
